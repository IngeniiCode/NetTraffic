...
if(defined($obj)) {
	...
	warn( "Babelfish server unavailable\n" ) unless defined($obj);
}
...
my $enc_str = uri_escape_utf8($string);
$enc_str = uri_escape_utf8('this is a test');
$bing_full_url = sprintf('http://api.microsofttranslator.com/v2/ajax.svc/TranslateArray2?appId=%22TVyAzrlurstNkKPw01yh7hpnibGjYPMpINXy3MnLYdT0*%22&texts=[%s]&from=%22zh-cht%22&to=%22en%22&oncomplete=_mstc5&onerror=_mste5&loc=en&ctr=&rgp=181969f1',$enc_str);
$bing_full_url = sprintf('http://api.microsofttranslator.com/v2/ajax.svc/TranslateArray2?appId=%22TVyAzrlurstNkKPw01yh7hpnibGjYPMpINXy3MnLYdT0*%22&texts=[%s]&from=%22en%22&to=%22zh-cht%22&oncomplete=_mstc5&onerror=_mste5&loc=en&ctr=&rgp=181969f1',$enc_str);
...
my $bing_base = 'http://api.microsofttranslator.com/v2/ajax.svc/TranslateArray2';
